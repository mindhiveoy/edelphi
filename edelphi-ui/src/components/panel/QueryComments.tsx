...
class QueryComments extends React.Component<Props, State> {
  ...
  private renderCategorized() {
    ...
    return <Tab menu={{ color: "orange", pointing: true }} panes={panes} />;
  }
  ...
  private loadData = async () => {
    ...
    const { panelId, pageId, queryId } = this.props;

    const queryQuestionCommentCategoriesService = await this.getQueryQuestionCommentCategoriesService(
