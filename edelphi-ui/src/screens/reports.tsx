...
class Reports extends React.Component<Props, State> {
    ...
    return (
      ...
      >
        <Modal open={this.state.reportToEmailDialogVisible}>
          <Modal.Header>
            {" "}
            {strings.panelAdmin.reports.reportToEmailTitle}{" "}
          </Modal.Header>
          <Modal.Content>
            <p>
              {strings.panelAdmin.reports.reportToEmailMessageDelivery}.{" "}
              {strings.panelAdmin.reports.reportToEmailMessageLeave}
            </p>
            <br />
            <p>
              <i>
                {strings.panelAdmin.reports.reportToEmailMessageDeliveryTime}
              </i>
            </p>
          </Modal.Content>
          <Modal.Actions>
            <Button
              color="green"
              onClick={() => {
                this.setState({ reportToEmailDialogVisible: false });
              }}
              inverted
            >
              <Icon name="checkmark" />
  ...
  private renderReportOptions = () => {
    ...
    return (
      <PanelAdminReportsOptions
        ...
        onExportReportSpreadsheetCsvClick={
          this.onExportReportSpreadsheetCsvClick
        }
        onExportReportSpreadsheetGoogleSheetsClick={
          this.onExportReportSpreadsheetGoogleSheetClick
        }
        onExportReportContentsGoogleDocumentClick={
          this.onExportReportContentsGoogleDocumentClick
        }
  ...
  private onCommentCategoriesChanged = (
    commentCategoryIds: number[] | "ALL"
  ) => {
    this.setState({
      commentCategoryIds
