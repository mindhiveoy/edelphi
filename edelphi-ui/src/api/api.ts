...
export default new (class Api {
   ...
   * @returns initialized QueryQuestionCommentsApi
   */
  public getQueryQuestionCommentsService = (
    accessToken: string
  ): QueryQuestionCommentsApi => {
   ...
   * @returns initialized QueryQuestionCommentCategoriesApi
   */
  public getQueryQuestionCommentCategoriesService = (
    accessToken: string
  ): QueryQuestionCommentCategoriesApi => {
    return new QueryQuestionCommentCategoriesApi(
      this.getConfiguration(accessToken)
    );
  };
   ...
   * @returns initialized QueryQuestionAnswersApi
   */
  public getQueryQuestionAnswersService = (
    accessToken: string
  ): QueryQuestionAnswersApi => {
   ...
   * @returns initialized PanelExpertiseApi
   */
  public getPanelExpertiseService = (
    accessToken: string
  ): PanelExpertiseApi => {
