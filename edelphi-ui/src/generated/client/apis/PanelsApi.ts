...
export class PanelsApi extends runtime.BaseAPI {
   ...
   */
  async findPanelRaw(
    requestParameters: FindPanelRequest
  ): Promise<runtime.ApiResponse<Panel>> {
    if (
      ...
      throw new runtime.RequiredError(
        "panelId",
        "Required parameter requestParameters.panelId was null or undefined when calling findPanel."
      );
    }
  ...
  async findPanel(requestParameters: FindPanelRequest): Promise<Panel> {
    if (MOCK_API) {
      return await getMockApiFile("findPanel");
    }
   ...
   */
  async listPanelsRaw(
    requestParameters: ListPanelsRequest
  ): Promise<runtime.ApiResponse<Array<Panel>>> {
    const queryParameters: runtime.HTTPQuery = {};
  ...
  async listPanels(
    ...
    if (MOCK_API) {
      return await getMockApiFile("listPanels");
    }
