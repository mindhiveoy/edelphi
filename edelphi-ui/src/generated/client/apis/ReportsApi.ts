...
import { ReportRequest, ReportRequestToJSON } from "../models";
...
export class ReportsApi extends runtime.BaseAPI {
   ...
   */
  async createReportRequestRaw(
    requestParameters: CreateReportRequestRequest
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "reportRequest",
        "Required parameter requestParameters.reportRequest was null or undefined when calling createReportRequest."
      );
    }
