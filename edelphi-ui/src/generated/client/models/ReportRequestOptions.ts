...
export function ReportRequestOptionsFromJSON(json: any): ReportRequestOptions {
  return ReportRequestOptionsFromJSONTyped(json);
}

export function ReportRequestOptionsFromJSONTyped(
  json: any
  ...
  return {
    queryPageIds: !exists(json, "queryPageIds")
      ? undefined
      : json["queryPageIds"],
    expertiseGroupIds: !exists(json, "expertiseGroupIds")
      ? undefined
      : json["expertiseGroupIds"],
    commentCategoryIds: !exists(json, "commentCategoryIds")
      ? undefined
      : json["commentCategoryIds"],
    show2dAs1d: !exists(json, "show2dAs1d") ? undefined : json["show2dAs1d"]
  };
}

export function ReportRequestOptionsToJSON(
  value?: ReportRequestOptions | null
): any {
  if (value === undefined) {
    return undefined;
  }
