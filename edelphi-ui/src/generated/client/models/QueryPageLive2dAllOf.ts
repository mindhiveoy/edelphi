...
export function QueryPageLive2dAllOfFromJSONTyped(
  json: any,
  ...
  return {
    answersVisible: !exists(json, "answersVisible")
      ? undefined
      : QueryPageLive2DAnswersVisibleOptionFromJSON(json["answersVisible"]),
    axisX: !exists(json, "axisX")
      ? undefined
      : QueryPageLive2DAxisFromJSON(json["axisX"]),
    axisY: !exists(json, "axisY")
      ? undefined
      : QueryPageLive2DAxisFromJSON(json["axisY"])
  };
}

export function QueryPageLive2dAllOfToJSON(
  value?: QueryPageLive2dAllOf | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    answersVisible: QueryPageLive2DAnswersVisibleOptionToJSON(
