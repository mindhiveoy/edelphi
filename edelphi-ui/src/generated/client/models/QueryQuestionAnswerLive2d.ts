...
export function QueryQuestionAnswerLive2dFromJSON(
  json: any
): QueryQuestionAnswerLive2d {
  return QueryQuestionAnswerLive2dFromJSONTyped(json, false);
}

export function QueryQuestionAnswerLive2dFromJSONTyped(
  json: any,
...
export function QueryQuestionAnswerLive2dToJSON(
  value?: QueryQuestionAnswerLive2d | null
): any {
  if (value === undefined) {
    return undefined;
  }
