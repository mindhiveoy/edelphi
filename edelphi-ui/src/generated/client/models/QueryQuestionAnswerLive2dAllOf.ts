...
export function QueryQuestionAnswerLive2dAllOfFromJSON(
  json: any
): QueryQuestionAnswerLive2dAllOf {
  return QueryQuestionAnswerLive2dAllOfFromJSONTyped(json, false);
}

export function QueryQuestionAnswerLive2dAllOfFromJSONTyped(
  json: any,
...
export function QueryQuestionAnswerLive2dAllOfToJSON(
  value?: QueryQuestionAnswerLive2dAllOf | null
): any {
  if (value === undefined) {
    return undefined;
  }
